...
public:
	...
	/** Создать и добавить воспоминание (упрощенный вариант) */
	UFUNCTION(BlueprintCallable, Category = "Memory")
	...
	/** Вспомнить (обновить дату последнего воспоминания и freshness) */
	UFUNCTION(BlueprintCallable, Category = "Memory")
	void RecallMemory(FName MemoryId);

	/** 
	 * Добавить теги к существующему воспоминанию
	 * 
	 * @param MemoryId ID воспоминания для добавления тегов
